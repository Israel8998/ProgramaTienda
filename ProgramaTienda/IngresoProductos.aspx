...
<body>
    <form id="form1" runat="server">
        ...
        <div class="btnsIngProd">
            <div class="mb-1">
                <asp:Button class="btn btn-outline-dark" ID="btnProductos" runat="server" Text="Productos" OnClick="btnProductos_Click" />
            </div>
            <div class="mb-1">
